	...
	while( !feof( handle ) )  {
        ...
        if( linestr[0] != '%' ) {
            ...
            if( strncmp( parameter, "ALL_Tau_mittel_Zeit", 18 ) == 0 ) {
                ...
                value = strtok( NULL, "\n" );
                sscanf( value, "%f", &ww_tww_sw );
            }
            else if( strncmp( parameter, "WW_Tww_Max", 10 ) == 0 ) {
                value = strtok( NULL, "\n" );
                sscanf( value, "%f", &ww_tww_max );
            }
            ...
            else if( strncmp( parameter, "WW_PU_REG_Kp", 12 ) == 0 ) {
                value = strtok( NULL, "\n" );
                sscanf( value, "%f", &ww_pu_reg_kp );
            }
            else if( strncmp( parameter, "WW_PU_REG_Tn", 12 ) == 0 ) {
                value = strtok( NULL, "\n" );
...
int main()
{
	...
	printf( "all_frostschutz = %f\n", all_frostschutz );
	printf( "all_at_start = %f\n", all_at_start );

	printf( "sol_dt_ein_sw = %f\n",	sol_dt_ein_sw );
	printf( "sol_dt_aus_sw = %f\n",	sol_dt_aus_sw );
	printf( "sol_koll_t_max = %f\n", sol_koll_t_max );
	printf( "sol_sp_t_max = %f\n", sol_sp_t_max );
	printf( "sol_sp1_t_min = %f\n", sol_sp1_t_min );

	printf( "kes_sp_dt_sw = %f\n", kes_sp_dt_sw );

	printf( "hk_tvl_steigung = %f\n", hk_tvl_steigung );
	printf( "hk_tvl_niveau = %f\n", hk_tvl_niveau );
	printf( "hk_tvl_absenk = %f\n", hk_tvl_absenk );
	printf( "hk_tvl_min = %f\n", hk_tvl_min );
	printf( "hk_tvl_max = %f\n", hk_tvl_max );
	printf( "hk_frostschutz = %f\n", hk_frostschutz );
	printf( "hk_reg_kp = %f\n", hk_reg_kp );
	printf( "hk_reg_tn = %f\n", hk_reg_tn );
	printf( "hk_tr_sw = %f\n", hk_tr_sw );
