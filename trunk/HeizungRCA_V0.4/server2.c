...
static void serv_printf( int fdesc, char *bufout, char *frmstr, float value )
{
    sprintf( bufout, frmstr, value );
    write( fdesc, bufout, strlen( bufout ) );
}
...
int parseGet( int fdesc, char *bufout )
{
    ...
    if( strncasecmp( token, "T", 1 ) == 0 ) {
        serv_printf( fdesc,  bufout, "ALL_Tau_MW     = %5.1f °C\n", ALL_Tau_MW );
        serv_printf( fdesc,  bufout, "SOL_KOLL_T_MW  = %5.1f °C\n", SOL_KOLL_T_MW );
        serv_printf( fdesc,  bufout, "SOL_SP1_To_MW  = %5.1f °C\n", SOL_SP1_To_MW );
        serv_printf( fdesc,  bufout, "SOL_SP1_Tu_MW  = %5.1f °C\n", SOL_SP1_Tu_MW );
        serv_printf( fdesc,  bufout, "SOL_SP2_To_MW  = %5.1f °C\n", SOL_SP2_To_MW );
        serv_printf( fdesc,  bufout, "SOL_SP2_Tu_MW  = %5.1f °C\n", SOL_SP2_Tu_MW );
        serv_printf( fdesc,  bufout, "KES_Tvl_MW     = %5.1f °C\n", KES_Tvl_MW );
        serv_printf( fdesc,  bufout, "KES_Trl_MW     = %5.1f °C\n", KES_Trl_MW );
        serv_printf( fdesc,  bufout, "HK_Tvl_MW      = %5.1f °C\n", HK_Tvl_MW );
        serv_printf( fdesc,  bufout, "HK_Trl_MW      = %5.1f °C\n", HK_Trl_MW );
        serv_printf( fdesc,  bufout, "FB_PRIM_Trl_MW = %5.1f °C\n", FB_PRIM_Trl_MW );
        serv_printf( fdesc,  bufout, "FB_SEK_Tvl_MW  = %5.1f °C\n", FB_SEK_Tvl_MW );
        serv_printf( fdesc,  bufout, "WW_HZG_Tvl_MW  = %5.1f °C\n", WW_HZG_Tvl_MW );
        serv_printf( fdesc,  bufout, "WW_HZG_Trl_MW  = %5.1f °C\n", WW_HZG_Trl_MW );
        serv_printf( fdesc,  bufout, "WW_Tww_MW      = %5.1f °C\n", WW_Tww_MW );
        serv_printf( fdesc,  bufout, "Tau_1h_mittel_f  = %6.2f °C\n", Tau_1h_mittel_f );
        serv_printf( fdesc,  bufout, "Tau_36h_mittel_f = %6.2f °C\n", Tau_36h_mittel_f );
    }
