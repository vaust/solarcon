...
typedef float   temperatur_t;
typedef u16_t   cnt_zaehler_t;

/**
 * @brief Datenstrukturen fuer Zaehlerklemme. Achtung: Belegt nicht Digitaleingaenge, sondern Analogeingaenge und
