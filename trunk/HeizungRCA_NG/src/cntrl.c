...
//    while( 1 ) {
        ...
        sol_in_Sp1.koll_t_mw = sol_in_Sp2.koll_t_mw                   = 35.0;  // = SOL_KOLL_T_MW;
        sol_in_Sp1.sp_to_mw  = ww_in.sol_sp1_to_mw = kes_in.sp1_to_mw = 67.9;  // = SOL_SP1_To_MW; 
        sol_in_Sp1.sp_tu_mw                        = kes_in.sp1_tu_mw = 34.0;  // = SOL_SP1_Tu_MW;  
        sol_in_Sp2.sp_to_mw                        = kes_in.sp2_to_mw = 37.0;  // = SOL_SP2_To_MW; 
        sol_in_Sp2.sp_tu_mw  = ww_in.sol_sp2_tu_mw = kes_in.sp2_tu_mw = 42.0;  // = SOL_SP2_Tu_MW;                     

        fb_in.tau_mw         = hk_in.tau_mw        = ww_in.tau_mw     = 11.0;   // = ALL_Tau_MW;
        fb_in.tau_avg        = hk_in.tau_avg       = ww_in.tau_avg    = 13.4;   // = tau.t_36h_mittel;
        fb_in.sek_tvl_mw                                              = 27.0;   // = FB_SEK_Tvl_MW;
        fb_in.zustand                                                 = zeit_absenkung.FB_Zustand;
        fb_in.partytime_flg  = hk_in.partytime_flg                    = zeit_party.all_partytime_flg;
        ...
        printf( "CNTRL.C: TEST: KES  : tvl_sw=%f pu_sp1_sb=%d pu_sp2_sb=%d\n", 
                kes_out.tvl_sw, (int)kes_out.pu_sp1_sb, (int)kes_out.pu_sp2_sb );
                printf( "\n" );        
#endif /* __TEST__ */
