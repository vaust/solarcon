...
static const parse_set_t telnet_fb_Vars[] =
{
    ...
    { "fb_out.prim_mv_y.x[0]  (Regelabw. e         )", &(cntrl_fb_out.prim_mv_y.x[0]), "%f" },
    { "fb_out.prim_mv_y.x[1] +(Ki x e x TA - Windup)", &(cntrl_fb_out.prim_mv_y.x[1]), "%f" },
    { "fb_out.prim_mv_y.x[2]  (Kp x e + ap + x[1]  )", &(cntrl_fb_out.prim_mv_y.x[2]), "%f" },
    { "fb_out.prim_mv_y.x[3]  (Windup              )", &(cntrl_fb_out.prim_mv_y.x[3]), "%f" },
...
static const parse_set_t telnet_hk_Vars[] =
{
    ...
    { "hk_out.mv_y.x[0]  (= Regelabw. e         )", &(cntrl_hk_out.mv_y.x[0]),      "%f" },
    { "hk_out.mv_y.x[1] +(= Ki x e x TA - Windup)", &(cntrl_hk_out.mv_y.x[1]),      "%f" },
    { "hk_out.mv_y.x[2]  (= Kp x e + ap + x[1]  )", &(cntrl_hk_out.mv_y.x[2]),      "%f" },
    { "hk_out.mv_y.x[3]  (= Windup              )", &(cntrl_hk_out.mv_y.x[3]),      "%f" },
...
static const parse_set_t telnet_ww_Vars[] =
{
    ...
    { "ww_out.hzg_pu_y.x[0]  (=  Regelabw. e        )", &(cntrl_ww_out.hzg_pu_y.x[0]),  "%f" },
    { "ww_out.hzg_pu_y.x[1] +(= Ki x e x TA - Windup)", &(cntrl_ww_out.hzg_pu_y.x[1]),  "%f" },
    { "ww_out.hzg_pu_y.x[2]  (=  Kp x e + ap + x[1] )", &(cntrl_ww_out.hzg_pu_y.x[2]),  "%f" },
    { "ww_out.hzg_pu_y.x[3]  (=  Windup             )", &(cntrl_ww_out.hzg_pu_y.x[3]),  "%f" },
