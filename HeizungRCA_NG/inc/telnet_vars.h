...
static const parse_set_t telnet_fb_Vars[] =
{
    ...
    { "fb_out.prim_mv_y.x[1] (Ki x e - Windup   )", &(cntrl_fb_out.prim_mv_y.x[1]), "%f" },
...
static const parse_set_t telnet_hk_Vars[] =
{
    ...
    { "hk_out.mv_y.x[1] (Ki x e - Windup   )", &(cntrl_hk_out.mv_y.x[1]),      "%f" },
...
static const parse_set_t telnet_ww_Vars[] =
{
    ...
    { "ww_out.hzg_pu_y.x[1] (Ki x e - Windup   )", &(cntrl_ww_out.hzg_pu_y.x[1]),  "%f" },
