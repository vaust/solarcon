...
#ifdef __DEBUG__
    printf( "DEBUG: Heizkoerper Vorlauftemperatur Sollwert  = %5.2f\n", hk_Tvl_SW_f );
    printf( "DEBUG: Heizkoerper Vorlauftemperatur Istwert   = %5.2f\n", toGradCelsius(HK_Tvl_MW) );
